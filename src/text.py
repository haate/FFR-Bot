...
cannot_vote_poll_closed = "this poll is not open, it either must first be started before voting, or this poll has ended"
cant_find_poll = "sorry, I cannot find a poll with that id, please try again"
confirm_end_poll = "Are you sure you want to end this poll?\nNo more votes will be able to be cast and the results will be calculated, to, proceed, reply `yes` to stop, type `no`"
confirm_vote = "Respond with a `yes` if your vote is correct or respond with a `no` if it is not. \nYour vote:"
...
not_enough_options = "there are less than two options for people to vote on!\n\nHere are the current options:\n\n"
not_in_server_long_enough = "This discord account has not been in the server for long enough to vote."
...
stv_submit_text = "To vote in this poll, rank the available options starting at 1, copy and paste the following, and replace the <x>s with your ranking (or leave the <x>s there if you dont want to rank them):"
